...
import { GoogleAuthProvider, createUserWithEmailAndPassword, onAuthStateChanged, signInWithEmailAndPassword, signInWithPopup, signOut, updateProfile,TwitterAuthProvider } from "firebase/auth";
...
const Provider = ({children}) => {
    ...
    // All value 
    const userInfo = {user, loading, registerUser, signInGoogle, logInUser, logOut, updateProfileFromUser,logInWithTwitter }
    return (
