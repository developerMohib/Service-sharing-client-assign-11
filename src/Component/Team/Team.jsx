    ...
    <div className="bg-gray-100">
      <div className="py-10 mx-auto">
        <div className="text-center mb-16">
          <p data-aos="fade-right" data-aos-duration="3000" data-aos-delay="1000" className="mt-4 text-sm leading-7 text-gray-500 font-regular">
            THE TEAM
          </p>
          <h3 data-aos="fade-right" data-aos-duration="3000" data-aos-delay="2000" className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
            Our<span className="text-indigo-600"> Tuitor </span>
          </h3>
        </div>

        <div className="md:grid grid-cols-3 gap-10 md:my-0 my-5 md:px-0 px-3 ">
          <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="1000" className="text-center bg-white gap-5 rounded-lg border border-slate-400 ">
            <img
              className="w-100"
          ...
          <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="2000" className="text-center bg-white gap-5 rounded-lg border border-slate-400">
            <img
              className="w-100"
          ...
          <div data-aos="fade-up" data-aos-duration="3000" data-aos-delay="2000" className="text-center bg-white gap-5 rounded-lg border border-slate-400">
            <img
              className="w-100"
