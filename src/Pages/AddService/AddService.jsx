      ...
      <div className=" p-10 ">
        <form onSubmit={handleAddService}>
          ...
          <div className="md:flex gap-8 my-5 ">
            <label data-aos="fade-right" data-aos-duration="3000" className="form-control w-full">
              <div className="label">
            ...
            <label data-aos="fade-left" data-aos-duration="3000" className="form-control w-full">
              <div className="label">
          ...
          <div className="my-5">
            <label data-aos="fade-up" data-aos-duration="3000" className="form-control w-full">
              <div className="label">
          ...
          <input data-aos="fade-up" data-aos-duration="3000"
